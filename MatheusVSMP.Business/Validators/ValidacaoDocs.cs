...
namespace MatheusVSMP.Business.Validators
{
    public class DocumentoValidacao {
    public virtual int Tamanho { get; private set; }
    }
    public class CpfValidacao : DocumentoValidacao
    {
        public new const int Tamanho = 11;
        ...
        {
            var number = valor.Substring(0, Tamanho - 2);
            ...
            return string.Concat(firstDigit, secondDigit) == valor.Substring(Tamanho - 2, 2);
        }
    }

    public class CnpjValidacao :DocumentoValidacao
    {
        public new const int Tamanho = 14;
